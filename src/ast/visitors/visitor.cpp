...
namespace soul
{
	...
	void IVisitor::visit(BlockNode& node) { visit(std::as_const(node)); }
	...
	void IVisitor::visit(LoopNode& node) { visit(std::as_const(node)); }
